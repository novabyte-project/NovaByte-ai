...
document.getElementById('btnSimplify').onclick = async () => {
    ...
    result.innerHTML = `<h3 style="color:var(--teal)">Simplified by Novabyte AI</h3><pre style="white-space: pre-wrap;">${output}</pre>`;
};
...
document.getElementById('btnQuestions').onclick = async () => {
    ...
    result.innerHTML = `<h3 style="color:var(--orange)">AI Generated Questions</h3><pre style="white-space: pre-wrap;">${output}</pre>`;
};
